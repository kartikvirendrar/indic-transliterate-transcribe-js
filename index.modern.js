...
function $cb083382c5991590$var$loadCacheFromLocalStorage() {
    const cachedData = localStorage.getItem($cb083382c5991590$var$CACHE_KEY);
    return cachedData ? JSON.parse(cachedData) : {};
}
function $cb083382c5991590$var$saveCacheToLocalStorage() {
    localStorage.setItem($cb083382c5991590$var$CACHE_KEY, JSON.stringify($cb083382c5991590$var$cache));
}
...
window.addEventListener("beforeunload", $cb083382c5991590$var$saveCacheToLocalStorage);
...
const $86cfb7ad4842cd1e$export$a62758b764e9e41d = ({ renderComponent: renderComponent = (props)=>/*#__PURE__*/ (0, $WrkLT$jsx)("input", {
    ...
    const handleBlur = (event)=>{
        if (!(0, $9acf2116f29b30de$export$e27e3030245d4c9b)()) {
