...
async function $0e1b765668e4d0aa$var$blobToWav(blob, targetRate = 16000) {
    ...
    try {
        ...
        return (0, $e9499f34e7fc5d70$export$1ceb7a840e500dd1)(out, targetRate);
    } finally{
        ctx.close().catch(()=>{});
    }
}
    ...
    const handleVoiceTyping = async ()=>{
        ...
        if (isRecording) {
            ...
            mediaRecorder.onstop = async ()=>{
                ...
                try {
                    const audioBlob = await $0e1b765668e4d0aa$var$blobToWav(recordedBlob);
